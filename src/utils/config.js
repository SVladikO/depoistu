...
export const CATEGORY_MAPPER = {
    ...
    3: {id: 3, title: resolveTranslation(TRANSLATION.CATEGORIES.HOT_DISHES), icon: LanguageIcon, measurement: MEASUREMENTS.WEIGHT},
    4: {id: 4, title: resolveTranslation(TRANSLATION.CATEGORIES.COLD_APPETIZERS), icon: LanguageIcon, measurement: MEASUREMENTS.WEIGHT},
    5: {id: 5, title: resolveTranslation(TRANSLATION.CATEGORIES.SIDE_DISHES), icon: LanguageIcon, measurement: MEASUREMENTS.WEIGHT},
    6: {id: 6, title: resolveTranslation(TRANSLATION.CATEGORIES.SPECIALITIES), icon: LanguageIcon, measurement: MEASUREMENTS.WEIGHT},
    7: {id: 7, title: resolveTranslation(TRANSLATION.CATEGORIES.BANQUET_MENU), icon: LanguageIcon, measurement: MEASUREMENTS.WEIGHT},
    8: {id: 8, title: resolveTranslation(TRANSLATION.CATEGORIES.SANDWITCH), icon: SandwitchIcon, measurement: MEASUREMENTS.WEIGHT},
    9: {id: 9, title: resolveTranslation(TRANSLATION.CATEGORIES.BURGERS), icon: BurgerIcon, measurement: MEASUREMENTS.WEIGHT},
    10: {id: 10, title: resolveTranslation(TRANSLATION.CATEGORIES.SUSHI), icon: LanguageIcon, measurement: MEASUREMENTS.WEIGHT},
    11: {id: 11, title: resolveTranslation(TRANSLATION.CATEGORIES.NOODLES), icon: NoodlesIcon, measurement: MEASUREMENTS.WEIGHT},
    12: {id: 12, title: resolveTranslation(TRANSLATION.CATEGORIES.PIZZA), icon: PizzaIcon, measurement: MEASUREMENTS.WEIGHT},
    13: {id: 13, title: resolveTranslation(TRANSLATION.CATEGORIES.SHAWARMA), icon: LanguageIcon, measurement: MEASUREMENTS.WEIGHT},
    14: {id: 14, title: resolveTranslation(TRANSLATION.CATEGORIES.SEAFOOD), icon: Sea_foodIcon, measurement: MEASUREMENTS.WEIGHT},
    15: {id: 15, title: resolveTranslation(TRANSLATION.CATEGORIES.SALADS), icon: VagetableIcon, measurement: MEASUREMENTS.WEIGHT},
    16: {id: 16, title: resolveTranslation(TRANSLATION.CATEGORIES.MEAT_DISHES), icon: LanguageIcon, measurement: MEASUREMENTS.WEIGHT},
    17: {id: 17, title: resolveTranslation(TRANSLATION.CATEGORIES.FISH_DISHES), icon: LanguageIcon, measurement: MEASUREMENTS.WEIGHT},
    18: {id: 18, title: resolveTranslation(TRANSLATION.CATEGORIES.DISHES_ON_FIRE), icon: LanguageIcon, measurement: MEASUREMENTS.WEIGHT},
    19: {id: 19, title: resolveTranslation(TRANSLATION.CATEGORIES.SAUCES), icon: LanguageIcon, measurement: MEASUREMENTS.WEIGHT},
    20: {id: 20, title: resolveTranslation(TRANSLATION.CATEGORIES.BAKERY), icon: BakeryIcon, measurement: MEASUREMENTS.WEIGHT},
    21: {id: 21, title: resolveTranslation(TRANSLATION.CATEGORIES.DESERTS), icon: LanguageIcon, measurement: MEASUREMENTS.WEIGHT},
    22: {id: 22, title: resolveTranslation(TRANSLATION.CATEGORIES.DRINKS), icon: BeverageIcon, measurement: MEASUREMENTS.LIQUID},
    23: {id: 23, title: resolveTranslation(TRANSLATION.CATEGORIES.HOT_DRINKS), icon: BeverageIcon, measurement: MEASUREMENTS.LIQUID},
    24: {id: 24, title: resolveTranslation(TRANSLATION.CATEGORIES.COCKTAILS), icon: LanguageIcon, measurement: ''},
    25: {id: 25, title: resolveTranslation(TRANSLATION.CATEGORIES.WINE_CARD), icon: BeverageIcon, measurement: MEASUREMENTS.LIQUID},
    26: {id: 26, title: resolveTranslation(TRANSLATION.CATEGORIES.ALCOHOL), icon: BeverageIcon, measurement: MEASUREMENTS.LIQUID},
};
