...
export const CATEGORY_MAPPER = {
    ...
    16: {id: 16, title: resolveTranslation(TRANSLATION.CATEGORIES.MEAT_DISHES), icon: LanguageIcon, measurement: 'g'},
    17: {id: 17, title: resolveTranslation(TRANSLATION.CATEGORIES.FISH_DISHES), icon: LanguageIcon, measurement: 'g'},
    18: {id: 18, title: resolveTranslation(TRANSLATION.CATEGORIES.DISHES_ON_FIRE), icon: LanguageIcon, measurement: 'g'},
    19: {id: 19, title: resolveTranslation(TRANSLATION.CATEGORIES.SAUCES), icon: LanguageIcon, measurement: 'g'},
