...
ROUTER.INTRO_1 = {
    URL: '/INTRO_1', TITLE: 'INTRO_1', page: () => {
    }
};
ROUTER.INTRO_2 = {
    URL: '/INTRO_2', TITLE: 'INTRO_2', page: () => {
    }
};
ROUTER.INTRO_3 = {
    URL: '/INTRO_3', TITLE: 'INTRO_3', page: () => {
    }
};
...
ROUTER.SUB_CATEGORY = {
    URL: '/category',
    PARAMS: '/:categoryId',
    getTitle: getSubCategoryTitle,
    page: SubCategoryPage,
    showBottomMenu: true,
    BACK_URL: ROUTER.CATEGORY.URL
};

ROUTER.Sing_up_phone_email = {
    URL: '/Sing_up_phone_email', TITLE: 'Sing_up_phone_email ', page: () => {
    }
};
ROUTER.Phone_verification = {
    URL: '/Phone_verification', TITLE: 'Phone_verification ', page: () => {
    }
};
ROUTER.OTP_verification = {
    URL: '/OTP_verification', TITLE: 'OTP_verification ', page: () => {
    }
};

ROUTER.Product_details_pizza = {
    URL: '/Product_details_pizza', TITLE: 'Product details pizza', page: () => {
    }
};
ROUTER.Product_details_pizza_2 = {
    URL: '/Product_details_pizza_2', TITLE: 'Product details pizza 2', page: () => {
    }
};
...
ROUTER.Payment_enter_data = {
    URL: '/Payment_enter_data', TITLE: 'Payment enter data', page: () => {
    }
};
ROUTER.Payment_enter_result = {
    URL: '/Payment_enter_result', TITLE: 'Payment enter result', page: () => {
    }
};
ROUTER.Order_history = {
    URL: '/History', TITLE: 'Order history', page: () => {
    }, subHeader: HistoryTabBar
};
ROUTER.Pizza_with_category = {
    URL: '/Pizza_with_category', TITLE: 'Pizza with category', page: () => {
    }
};
ROUTER.Order_history_completed = {
    URL: '/Order_history_completed',
    TITLE: 'Order history completed',
    page: OrderHistoryPage,
    subHeader: HistoryTabBar,
    BACK_URL: ROUTER.Order_history.URL
}
ROUTER.Order_history_upcoming = {
    URL: '/Order_history_upcoming', TITLE: 'Order history upcoming', page: () => {
    }
};
ROUTER.Order_history_cancelled = {
    URL: '/Order_history_cancelled', TITLE: 'Order history cancelled', page: () => {
    }
};
ROUTER.Favorite = {
    URL: '/Favorite', TITLE: 'Favorite', page: () => {
    }
};
ROUTER.Profile = {
    URL: '/Profile', TITLE: 'Profile', page: () => {
    }
};
ROUTER.Track_your_order = {
    URL: '/Track your order', TITLE: 'Track your order', page: () => {
    }
};
ROUTER.Support = {
    URL: '/Support', TITLE: 'Support', page: () => {
    }
};
ROUTER.SETTING = {URL: '/setting', TITLE: 'Setting', page: SettingPage, showBottomMenu: true};
ROUTER.USER_ACCOUNT = {
    URL: '/user_account', TITLE: 'USER_ACCOUNT', page: () => {
    }, showBottomMenu: true, BACK_URL: ROUTER.SETTING.URL
};
