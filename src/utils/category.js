...
export const CATEGORY_KITCHEN = [
    ...
    {id: 36, title: TR.SUB_CATEGORIES.SECOND_DISHES, measurement: MEASUREMENTS.LIQUID},
    ...
    {id: 37, title: TR.SUB_CATEGORIES.DUMPLING, measurement: MEASUREMENTS.LIQUID},
    {id: 38, title: TR.SUB_CATEGORIES.PANCAKES, measurement: MEASUREMENTS.LIQUID},
    {id: 3, title: TR.SUB_CATEGORIES.BUSINESS_LUNCH, measurement: MEASUREMENTS.LIQUID},
    ...
    {id: 23, title: TR.SUB_CATEGORIES.ADDICTIVES, measurement: MEASUREMENTS.LIQUID},
];
...
export const CATEGORY_DESSERTS = [
    ...
    {id: 51, title: TR.SUB_CATEGORIES.ICE_CREAM, measurement: MEASUREMENTS.LIQUID},
];
//
