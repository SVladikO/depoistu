...
const componentsGroup1 = [
    ...
    [
        {title: 'PrimaryButton', component: <FetchButton><GoogleIcon/>Google</FetchButton>},
        {title: 'PrimaryButton', component: <FetchButton>Sing in</FetchButton>},
        {title: 'PrimaryButton isWide', component: <FetchButton isWide>Sing in</FetchButton>},
        {title: 'PrimaryButton isLoading isWide', component: <FetchButton isLoading isWide>Loading</FetchButton>},
